...
//post request from the script.js file and it writes the data into file.json
...
//getting a get request from the display.js for the data obtained in file.json
